...
#%%
for var_name in ['Twet','utci']:
    adv_1 = np.array(xr.open_dataset('/Net/Groups/BGI/scratch/yt/data/era5_daily_1x1/'+var_name+'_ano_1979_2020_dailymean_1x1_del29Feb_detrend.nc') ['__xarray_dataarray_variable__'][:][:])# HW_vrh_ano = get_HW_ano_mean(vrh_ano, HW_date,HW_lat,HW_lon)
    ...
    temp3_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/result/Heat_wave_3D_99th_connect6_025_degree/strict_significance_'+var_name+'_daily_detrend.nc')
    del temp3_xr,temp3
...
for var_name, var_name1 in zip (['t2m','rH_cf'],['an','calc']):
