...
for i_label in range(4):
    N_all.append(np.array(xr.open_dataset('/Net/Groups/BGI/scratch/yt/result/Heat_wave_3D_99th_connect6_025_degree/strict_significance_N_'+str(i_label)+'monthly'+vername+'_weighted.nc') ['__xarray_dataarray_variable__'][:][:]))
#%%
...
var_name = 'NEE'
temp = get_HW_ano_all_mean(NEE_ano.ravel(), N_all)
temp_xr = xr.DataArray(temp)
temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/result/Heat_wave_3D_99th_connect6_025_degree/strict_significance_'+var_name+'_monthly'+vername+'_detrend_weighted.nc')
...
var_name = 'GPP'
temp = get_HW_ano_all_mean(GPP_ano.ravel(), N_all)
temp_xr = xr.DataArray(temp)
temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/result/Heat_wave_3D_99th_connect6_025_degree/strict_significance_'+var_name+'_monthly'+vername+'_detrend_weighted.nc')
...
var_name = 'TER'
temp = get_HW_ano_all_mean(TER_ano.ravel(), N_all)
temp_xr = xr.DataArray(temp)
temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/result/Heat_wave_3D_99th_connect6_025_degree/strict_significance_'+var_name+'_monthly'+vername+'_detrend_weighted.nc')
