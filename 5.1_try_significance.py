...
for i_model,modelname in enumerate(['CanESM5/','INM-CM4-8/','INM-CM5-0/','MPI-ESM1-2-LR/','MRI-ESM2-0/','CMCC-ESM2/','IPSL-CM6A-LR/']):
    ...
    delta_ssr_po.append(np.array([np.nanmean(delta_ssr.ravel()[iii]) for iii in indices_random]))
    delta_slhf_po.append(np.array([np.nanmean(delta_slhf.ravel()[iii]) for iii in indices_random]))
    delta_SDcorr_po.append(np.array([np.nanmean(delta_SDcorr.ravel()[iii]) for iii in indices_random]))
    delta_SDslope_po.append(np.array([np.nanmean(delta_SDslope.ravel()[iii]) for iii in indices_random]))
    ...
    delta_ssr_ne.append(np.array([np.nanmean(delta_ssr.ravel()[iii]) for iii in indices_random]))
    delta_slhf_ne.append(np.array([np.nanmean(delta_slhf.ravel()[iii]) for iii in indices_random]))
    delta_SDcorr_ne.append(np.array([np.nanmean(delta_SDcorr.ravel()[iii]) for iii in indices_random]))
    delta_SDslope_ne.append(np.array([np.nanmean(delta_SDslope.ravel()[iii]) for iii in indices_random]))



    temp_xr = xr.DataArray(np.array(delta_ssr_po))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_ssr_po.nc')

    temp_xr = xr.DataArray(np.array(delta_slhf_po))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_slhf_po.nc')

    temp_xr = xr.DataArray(np.array(delta_SDcorr_po))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_SDcorr_po.nc')

    temp_xr = xr.DataArray(np.array(delta_SDslope_po))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_SDslope_po.nc')


    temp_xr = xr.DataArray(np.array(delta_ssr_ne))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_ssr_ne.nc')

    temp_xr = xr.DataArray(np.array(delta_slhf_ne))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_slhf_ne.nc')

    temp_xr = xr.DataArray(np.array(delta_SDcorr_ne))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_SDcorr_ne.nc')

    temp_xr = xr.DataArray(np.array(delta_SDslope_ne))
    temp_xr.to_netcdf('/Net/Groups/BGI/scratch/yt/data/Cmip6_ssp585_wget/'+modelname+'sig_'+'_delta_SDslope_ne.nc')
